...
const receipt = { id: "r1", schemaVersion: 1 as const, creatorType: "HUMAN" as const, creatorId: "0xabc", creatorWallet: "0xabc0000000000000000000000000000000000123" as `0x${string}`, marketId: "m1", marketIdHash: `0x${"1".repeat(64)}` as `0x${string}`, direction: "UP" as const, confidenceBps: 7000, thesis: "Up thesis", counterCase: "Down case", invalidationCondition: "Break below", createdAt: 1, locksAt: 2, revision: 1, previousReceiptHash: null, canonicalHash: `0x${"2".repeat(64)}` as `0x${string}`, authorizationType: "EIP712" as const, authorizationValue: "0xsig", proofState: "ANCHORED" as const }
