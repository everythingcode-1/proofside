...
export default function Home() {
  ...
  return <main><SiteHeader active="FORECASTS" />
    ...
    <section className="execution-section"><div className="section-title"><p className="eyebrow">Live DreamDEX room</p><h2>See the market. Choose a side.</h2><p>Trade directly, or open the optional Decision Lab when you want agent evidence and a verifiable reasoning record.</p></div><PredictionRoom /></section>
