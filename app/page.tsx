...
export default function Home() {
  ...
  return <main><SiteHeader active="FORECASTS" />
    ...
    <section className="execution-section"><div className="section-title"><p className="eyebrow">Optional economic backing</p><h2>Back the thesis on DreamDEX.</h2><p>A forecast measures judgment. A position proves conviction. They remain separate and verifiable.</p></div><PredictionRoom /></section>
